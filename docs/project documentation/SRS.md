...
3. [Системные требования](#systemrequirements)
  3.1 [Функциональные требования](#functionalrequirements)
    ...
    3.1.5 [Бронирование книги] (#bookbook)
    3.1.6 [Управление информацией о книгах] (#managementbook)
    3.1.7 [Управление информацией о заказах пользователей] (#Управление информацией о заказах пользователей)
